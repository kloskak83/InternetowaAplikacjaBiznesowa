...
namespace BazaDanych.Migrations
{
    ...
    [Migration("20240623095055_DodanoPolaDlaMenuUzupelnionoIsDeleted2")]
    partial class DodanoPolaDlaMenuUzupelnionoIsDeleted2
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BazaDanych.Data.CMS.Pojazd", b =>
                {
                    ...
                    b.Property<decimal>("KosztWypozyczeniaDoba")
            ...
            modelBuilder.Entity("BazaDanych.Data.CMS.PojazdSlCechaPojazdu", b =>
                {
                    b.Property<int>("PojazdsIdPojazd")
                        .HasColumnType("int");

                    b.Property<int>("SlCechaPojazdusId")
                        .HasColumnType("int");
                    ...
                    b.HasKey("PojazdsIdPojazd", "SlCechaPojazdusId");

                    b.HasIndex("SlCechaPojazdusId");
            ...
            modelBuilder.Entity("BazaDanych.Data.CMS.Wypozyczenia.NazwaStatusuWypozyczenia", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("NazwaWypozyczenia")
                        .IsRequired()
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)");
                    ...
                    b.ToTable("StatusWypozyczenia");
                });

            modelBuilder.Entity("BazaDanych.Data.CMS.Wypozyczenia.RejestrWypozyczen", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("IdNazwaStatusuWypozyczenia")
                        .HasColumnType("int");
                    ...
                    b.Property<DateTime>("WypozyczenieDo")
                        .HasColumnType("datetime2");

                    b.Property<DateTime>("WypozyczenieOd")
                        .HasColumnType("datetime2");

                    b.HasKey("Id");

                    b.HasIndex("IdNazwaStatusuWypozyczenia");

                    b.HasIndex("IdPojazd");

                    b.HasIndex("IdUzytkownik");

                    b.ToTable("RejestrWypozyczens");
                });

            modelBuilder.Entity("BazaDanych.Data.Menu.MenuGorne", b =>
                {
                    b.Property<int>("IdMenuGorne")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("IdMenuGorne"));

                    b.Property<bool>("IsDeleted")
                        .HasColumnType("bit");

                    b.Property<string>("NaglowekIntranet")
                        .IsRequired()
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)");

                    b.Property<string>("NazwaPortal")
                        .IsRequired()
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)");

                    b.Property<int>("TypPolaId")
                        .HasColumnType("int");

                    b.HasKey("IdMenuGorne");

                    b.ToTable("MenuGornes");
                });
            ...
            modelBuilder.Entity("BazaDanych.Data.Portal.StronaNaSztywno", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BazaDanych.Data.CMS.PojazdSlCechaPojazdu", b =>
                {
                    b.HasOne("BazaDanych.Data.CMS.Pojazd", null)
                        .WithMany()
                        .HasForeignKey("PojazdsIdPojazd")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BazaDanych.Data.CMS.SlCechaPojazdu", null)
                        .WithMany()
                        .HasForeignKey("SlCechaPojazdusId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("BazaDanych.Data.CMS.Wypozyczenia.RejestrWypozyczen", b =>
                {
                    b.HasOne("BazaDanych.Data.CMS.Wypozyczenia.NazwaStatusuWypozyczenia", "NazwaStatusuWypozyczenia")
                        .WithMany("Pojazdy")
                        .HasForeignKey("IdNazwaStatusuWypozyczenia")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BazaDanych.Data.CMS.Pojazd", "Pojazd")
                        .WithMany("RejestrWypozyczens")
                        .HasForeignKey("IdPojazd")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BazaDanych.Data.CMS.Uzytkownicy.Uzytkownik", "Uzytkownik")
                        .WithMany("RejestrWypozyczens")
                        .HasForeignKey("IdUzytkownik")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("NazwaStatusuWypozyczenia");
            ...
            modelBuilder.Entity("BazaDanych.Data.CMS.Pojazd", b =>
                {
                    b.Navigation("RejestrWypozyczens");
                });
