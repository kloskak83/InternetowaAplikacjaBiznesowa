...
namespace BazaDanych.Migrations
{
    ...
    [Migration("20240617131048_UtworzonoKlasyZRejestremWypozyczen")]
    partial class UtworzonoKlasyZRejestremWypozyczen
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BazaDanych.Data.CMS.Wypozyczenia.RejestrWypozyczen", b =>
                {
                    ...
                    b.Property<int>("StatusWypozyczeniaId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("StatusWypozyczeniaId");
            ...
            modelBuilder.Entity("BazaDanych.Data.CMS.Wypozyczenia.RejestrWypozyczen", b =>
                {
                    ...
                    b.HasOne("BazaDanych.Data.CMS.Wypozyczenia.NazwaStatusuWypozyczenia", "StatusWypozyczenia")
                        .WithMany("Pojazdy")
                        .HasForeignKey("StatusWypozyczeniaId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("Pojazd");

                    b.Navigation("StatusWypozyczenia");
